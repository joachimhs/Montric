Montric.AdministrationRoute = Ember.Route.extend({
    ...
    setupController : function(controller) {
        ...
        this.store.find('adminMenuModel');
        var mainMenu = this.store.filter('adminMenuModel', function(data) {
        ...
        adminMenuController.set('content', this.store.find('adminMenuModel'));
    }
});