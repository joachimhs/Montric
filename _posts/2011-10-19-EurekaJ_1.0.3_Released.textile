...
EurekaJ 1.0.2 can be downloaded from: <a href="http://nightly.haagen.name/EurekaJ/1.0.3/">http://nightly.haagen.name/EurekaJ/1.0.3/</a>.

h3. Changelog

1.0.3 - cache sizing options and node deletiaon 
