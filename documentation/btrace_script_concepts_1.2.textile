...
h3. Importing the utilities methods and declaring the script as a BTrace script
...
To be able to profile methods efficiently BTrace supplies the Profiler class, from version 1.2 an onwards. The Profiler class will successfully instrument any method specified, and will record the following key information regarding the execution of that method: 
